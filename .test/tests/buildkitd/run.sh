...
# mimic https://github.com/docker-library/official-images/blob/09efb10abd3214d02ad9a502b7358797acf486a8/.bin/docker-buildx-ensure.sh (since it's the primary user of khulnasoft/buildkit)

builderName='khulnasoft-test-buildkit'
tmp=
...
# https://github.com/khulnasoft/docker-bin/blob/master/docker-save-oci-layout.sh
saveMe='https://github.com/khulnasoft/docker-bin/raw/67e6dbb725b3df2def1ac74820b61d9cefedc090/docker-save-oci-layout.sh'
